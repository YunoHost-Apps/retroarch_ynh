...
**Shipped version:** 1.10.3 *(:warning: This is the `ci-auto-update-v1.11.0` branch. The [`master` branch](https://github.com/YunoHost-Apps/retroarch_ynh/tree/master) used in the catalog is currently on version 1.10.3\~ynh1.)*
