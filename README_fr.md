...
**Version incluse :** 1.10.3 *(:warning: Il s'agit de la branche `ci-auto-update-v1.11.0`. La [branche `master`](https://github.com/YunoHost-Apps/retroarch_ynh/tree/master) utilisée dans le catalogue est actuellement en 1.10.3\~ynh1.)*
